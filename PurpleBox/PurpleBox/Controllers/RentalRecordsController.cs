...
namespace PurpleBox.Controllers
{
    public class RentalRecordsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MovieID,CustomerID,RentalDate,RentalID,DueDate,ReturnDate")] RentalRecord rentalRecord)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MovieID,CustomerID,RentalDate,RentalID,DueDate,ReturnDate")] RentalRecord rentalRecord)
        {
            if (ModelState.IsValid)
            {
